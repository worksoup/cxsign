...
async fn main() {
        ...
        fn on_login_tips(main_window: &Weak<MainWindow>) {
            ...
            main_window
                .upgrade_in_event_loop(|main_window| {
                    println!("正在登录，登录页已禁用！");
                    main_window.set_login_page_enabled(false);
                })
                .unwrap_or_else(|e| {
        ...
        fn on_login_failed_tips(main_window: &Weak<MainWindow>) {
            ...
            main_window
                .upgrade_in_event_loop(|main_window| {
                    ...
                    main_window.set_login_page_enabled(true);
                })
                .unwrap_or_else(|e| {
        ...
        fn on_login_successed_tips(main_window: &Weak<MainWindow>) {
            ...
            main_window
                .upgrade_in_event_loop(|main_window| {
                    ...
                    main_window.set_login_page(false);
                    main_window.set_login_page_enabled(true);
                })
                .unwrap_or_else(|e| {
        ...
        fn on_login_reqead(main_window: &Weak<MainWindow>) {
            ...
            main_window
                .upgrade_in_event_loop(|main_window| {
                    ...
                    main_window.set_login_page(true);
                })
                .unwrap_or_else(|e| {
    ...
    tokio::spawn(async move {
        while let Some((uname, s)) = session_rx.next().await {
            ...
            let _ = course_tx.unbounded_send(courses);
